...
class Post {
  ...
  Post({ this.username, this.date, this.likes, this.comments, this.ImageUrlAvatar,this.loc ,this.ImageUrlPost, this.caption, this.reposts});
}
location x = location(loc_name: "Some Location", longitude: 41, latitude: 28.9);

Post post = Post(username: "Some Name",loc: x, likes: 100, ImageUrlAvatar: "assets/Dog/cutegolden.jpg", reposts: 20,
...
List<Post> posts = [Post(username: "Generic Name",loc: x, likes: 15, ImageUrlAvatar: "assets/Dog/another.jpg", reposts: 20,
  ...
  Post(username: "other Name",loc: x, likes: 100, ImageUrlAvatar: "assets/Dog/last.jpg", reposts: 58,
  ...
  Post(username: "Generic Name",loc: x, likes: 235, ImageUrlAvatar: "assets/Dog/cutegolden.jpg", reposts: 62,
  ...
  Post(username: "Generic Name",loc: x, likes: 1880, ImageUrlAvatar: "assets/Dog/cuteshiba.png", reposts: 108,
  ...
  Post(username: "Generic Name",loc: x, likes: 10000, ImageUrlAvatar: "assets/Dog/cutepug.jpg", reposts: 50,
      ImageUrlPost: "assets/Dog/husky.jpg", caption: "caption.This is a generic sentence.This is a generic sentence.", date: "April 17 2021", comments: 0)];
